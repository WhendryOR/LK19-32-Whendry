...
<body>
    <h1 align="center">Login, Register dan CRUD dengan PHP</h1>
 <div class="container">
        <?php
  ...
  <div class="regisForm">
   <form action="akunuser.php" method="post">
    ...
    <div class="tbl-kirim">
     <a href="home.php"> <input type="submit" name="loginSubmit" value="Login">
    </div>
   </form>
  </div>
        
 </div>
 <p align="center"><a href="daftar.php">Buat Akun</a></p>
 <?php } ?>
</body>
</html>